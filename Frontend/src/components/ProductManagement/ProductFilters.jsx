...
import { Search, PackagePlus, RefreshCw, Layers3, Zap, ToggleLeft } from 'lucide-react';
...
const ProductFilters = ({
  ...
  // Flatten categories tree thành mảng phẳng cho select
    ...
    <div className="flex flex-col xl:flex-row justify-between items-center gap-4 mb-6">
      ...
      <div className="flex items-center gap-3 w-full xl:w-auto flex-wrap">
        ...
        <div className="relative">
          ...
          <select value={categoryFilter} onChange={(e) => setCategoryFilter(e.target.value)} className={`${selectClass} min-w-[160px]`}>
        ...
        <div className="relative">
          ...
          <select value={brandFilter} onChange={(e) => setBrandFilter(e.target.value)} className={`${selectClass} min-w-[160px]`}>
        ...
        {/* Trạng thái */}
        <div className="relative">
          <ToggleLeft className="absolute left-3 top-1/2 -translate-y-1/2 text-slate-400 z-10" size={16} />
          <select value={statusFilter} onChange={(e) => setStatusFilter(e.target.value)} className={`${selectClass} min-w-[140px]`}>
