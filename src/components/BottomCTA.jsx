  ...
  return (
    <section className="py-20 md:py-32 relative flex justify-center items-center text-center overflow-hidden min-h-[40vh] md:min-h-[50vh]">
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-full z-[1] pointer-events-none opacity-15 hidden md:block">
        <p className="text-[1.1rem] leading-loose font-medium text-slate-400 [mask-image:radial-gradient(ellipse_at_center,black_10%,transparent_80%)]">
      ...
      <div className="relative z-10 flex flex-col items-center">
        ...
        <button className="bg-slate-800 text-white py-4 px-8 rounded-lg font-medium text-base inline-flex items-center gap-2 transition-all duration-200 hover:bg-slate-900 hover:-translate-y-[2px]">
          Tham gia ChatBot ↗
        </button>
      </div>
    </section>
