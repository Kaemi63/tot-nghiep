    ...
    <header className="fixed top-0 left-0 w-full py-6 z-[1000] bg-white/80 backdrop-blur-md">
      <div className="max-w-[1200px] mx-auto flex justify-between items-center px-6 md:px-8">
        ...
        <div className="flex items-center gap-6">
          ...
          <button className="bg-slate-800 text-white py-2 px-5 rounded-lg font-medium text-[0.95rem] flex items-center gap-2 transition-all duration-200 hover:bg-slate-950 hover:-translate-y-[1px]">
            Đăng nhập
